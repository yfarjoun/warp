...
| [DragmapAlignment.SamToFastqAndDragmapAndMba (SamToFastqAndDragmapAndMba)](https://github.com/broadinstitute/warp/blob/master/tasks/broad/DragmapAlignment.wdl) | MergeBamAlignment | dragen-os, Picard | When `use_bwa_mem` = false, aligns with the Dragmap aligner. |
